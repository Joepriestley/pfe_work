                ...
                <tbody id="circuitTable" class="text-dark border">
                    ...
                    <?php foreach ($results as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="agriculture-edit.php?id=<?= $row['codeactivite'] ?>"><button name="edit_agriculture" class="edit-btn" style="background-color:rgb(61,131,97,1);" data-id="<?= $row['codeactivite'] ?>">Editer</button></a>
                            </td>
                            <td>

                                <!-- Delete form -->
                                <form style="border:0px; padding:0px;" action="./deletion/agriculture-delete.php" method="POST">
                                    <!-- Hidden input field to include codeactivite -->
                                    <input type="hidden" name="codeactivite" value="<?= $row['codeactivite'] ?>">
                                    <!-- Delete button -->
                                    <button name="delete_agriculture" class="delete-btn btn"  style="background-color:rgb(61,131,97,1);" onclick="return confirm('Etes vous d\'effacer cette ligne?');">Effacer</button>
                                </form>
