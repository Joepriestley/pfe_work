...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_vegetal'])) {
    ...
    try {
        ...
        $query = "SELECT photo FROM espece_vegetale WHERE nomscientifique = :nomscientifique";
        ...
        $deleteQuery = "DELETE FROM espece_vegetale WHERE nomscientifique = :nomscientifique";
        ...
        if ($stmt) {
            ...
            if ($result) {
                ...
                header("Location: ../esp_vegetal.php?message=Record deleted successfully!");
                exit();
            } else {
